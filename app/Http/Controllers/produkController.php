...
{
    /** @var produkRepository $produkRepository*/
    ...
    public function store(CreateprodukRequest $request)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            $path = "produk/" . $imageName;
        }

        $input['foto'] = $path;

        $this->produkRepository->create($input);
    ...
    {
        $data = $this->produkRepository->all();
        return view('utama.shop', ["data" => $data]);
    }
}
